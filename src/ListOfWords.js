/*
In here, maybe make this an array of objects, and each object that you return is the card with info. So basically, word in italian and then english!

GOALS: flashcards with a next, back and displays the card
*/
let allWords = [
    {
      id: 1,
...
//   const mappedList = () =>
//   allWords.map((id, italian, english) => {
//       return(
//           <p key={id} italian={italian} english={english}> </p> 
//       )
//   })
export default function ListOfWords(){
  ...
  allWords.map((id, italian, english) => {
      return(
          <p key={id} italian={italian} english={english}/>
      );
  })
return (
    <div>
